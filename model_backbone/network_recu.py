...
from model_backbone.layers_recu import *
...
class ResNet_Recu(nn.Module):

    def __init__(self, hash_bit=64, block=BasicBlock, layers=[3, 4, 6, 3],  
        ...
        self.inplanes = 64
        super(ResNet_Recu, self).__init__()

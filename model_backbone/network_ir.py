...
from model_backbone import layers_ir
...
class BasicBlock(nn.Module):
   ...
   def __init__(self, in_planes, planes, device, stride=1):

       super(BasicBlock, self).__init__()

       self.conv1 = layers_ir.IRConv2d(in_planes, planes, kernel_size=3, device=device, stride=stride, padding=1, bias=False)
       self.bn1 = nn.BatchNorm2d(planes)
       self.conv2 = layers_ir.IRConv2d(planes, planes, kernel_size=3, device=device, stride=1, padding=1, bias=False)
...
class Bottleneck(nn.Module):
   ...
   def __init__(self, in_planes, planes, stride=1):
       ...
       self.conv1 = layers_ir.IRConv2d(in_planes, planes, kernel_size=1, bias=False)
       self.bn1 = nn.BatchNorm2d(planes)
       self.conv2 = layers_ir.IRConv2d(planes, planes, kernel_size=3, stride=stride, padding=1, bias=False)
       self.bn2 = nn.BatchNorm2d(planes)
       self.conv3 = layers_ir.IRConv2d(planes, self.expansion*planes, kernel_size=1, bias=False)
...
class ResNet_IR(nn.Module):
   ...
   def __init__(self, hash_bit, device, block=BasicBlock, num_blocks=[2,2,2,2]):
